...
while True:
    ...
    if forum_thread_page_num == last_page_of_thread:
        ...
        if url_has_already_been_scraped == "No":
            ...
            thread_info_dict.update({'url': split_url})
            ...
            print("new thread title added to DB!")
        else:
            print("Thread title not added. It has already been scraped!")
